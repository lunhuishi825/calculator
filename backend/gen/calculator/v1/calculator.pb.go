...
type CalculateRequest struct {
	...
	LeftOperand   float64                `protobuf:"fixed64,1,opt,name=left_operand,json=leftOperand,proto3" json:"left_operand,omitempty"`      // 左操作数
	RightOperand  float64                `protobuf:"fixed64,2,opt,name=right_operand,json=rightOperand,proto3" json:"right_operand,omitempty"`   // 右操作数
	Operation     Operation              `protobuf:"varint,3,opt,name=operation,proto3,enum=calculator.v1.Operation" json:"operation,omitempty"` // 操作类型
...
func (x *CalculateRequest) GetLeftOperand() float64 {
	if x != nil {
...
func (x *CalculateRequest) GetRightOperand() float64 {
	if x != nil {
...
type CalculateResponse struct {
	...
	Error         string                 `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`     // 错误信息（如果有）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_calculator_v1_calculator_proto_rawDesc = "" +
	"\n" +
	"\x1ecalculator/v1/calculator.proto\x12\rcalculator.v1\"\x92\x01\n" +
	"\x10CalculateRequest\x12!\n" +
	"\fleft_operand\x18\x01 \x01(\x01R\vleftOperand\x12#\n" +
	"\rright_operand\x18\x02 \x01(\x01R\frightOperand\x126\n" +
	...
	"\tCalculate\x12\x1f.calculator.v1.CalculateRequest\x1a .calculator.v1.CalculateResponse\"\x00B3Z1calculator/backend/gen/calculator/v1;calculatorv1b\x06proto3"
